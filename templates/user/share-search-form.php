...
<div class="opalestate-popup">
    <div class="popup-head <?php if( !is_user_logged_in() ): ?> opalestate-need-login <?php endif; ?>"><span class="text-primary"><i class="fa fa-envelope" aria-hidden="true"></i> <?php _e('Compartir esta búsqueda', 'opalestate') ?></span> <?php _e('con amigos y familia', 'opalestate') ?></div>
