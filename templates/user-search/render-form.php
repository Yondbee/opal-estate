...
<div class="opalestate-popup">
    <div class="popup-head <?php if( !is_user_logged_in() ): ?> opalestate-need-login <?php endif; ?>"><span><i class="fa fa-star" aria-hidden="true"></i> <?php _e('Guardar búsqueda', 'opalestate') ?></span></div>
    <div class="popup-body">
        <div class="popup-close"><i class="fa fa-times" aria-hidden="true"></i></div>
      
            <div class="contact-share-form-container">
               
                <h6><?php echo __( 'Nombra la busqueda', 'opalestate' ); ?></h6>
                ...
                <div class="box-content agent-contact-form">
                    ...
                    <form method="post" action="" id="opalestate-save-search-form">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="name" type="text" placeholder="<?php echo __( 'Nombre', 'opalestate' ); ?>" required="required">
                        </div><!-- /.form-group -->

                        <?php do_action('opalestate_contact_share_form_after'); ?>
                        <button class="button btn btn-primary btn-3d btn-block" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo __( ' Procesando', 'opalestate' ); ?>" type="submit" name="contact-form"><?php echo __( 'Save', 'opalestate' ); ?></button>
                    </form>
