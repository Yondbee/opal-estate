		 ...
		 <ul class="property-meta-list list-inline">
			<?php if( $meta ) : ?>
				<?php foreach( $meta as $key => $info ) : ?>
					...
					<li class="property-label-<?php echo $key; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $info['label']; ?>">
                        <?php if($key == 'bathrooms') { ?>
                           <img class="img-responsive icons" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/iconos/Bañera.png">
                       <?php }
                       if($key == 'bedrooms') { ?>
                            <img class="img-responsive icons" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/iconos/Cama.png">
                        <?php }
                       if($key == 'parking') { ?>
                            <img class="img-responsive icons" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/iconos/Coche.png">
                        <? } ?>
                        <span class="label-property"><?php echo $info['label']; ?></span>
                        <span class="label-content"><?php echo apply_filters( 'opalestate'.$key.'_unit_format',  trim($info['value']) ); ?></span>
                    </li>
					<?php endif; ?>
				<?php endforeach; ?>
			<?php endif; ?>
...
function opalestate_render_sortable_dropdown( $selected='', $class='' ){
	...
	$output = '';
		$modes = array(
			'featured_desc'		=> __( 'Destacado descendente', 'opalestate' ),
			'price_asc' 		=> __( 'Precio ascendente', 'opalestate' ),
			'price_desc' 		=> __( 'Precio descendente', 'opalestate' ),
			'areasize_asc' 		=> __( 'Area ascendente', 'opalestate' ),
			'areasize_desc' 	=> __( 'Area descendente', 'opalestate' ),
		);
		$modes  = apply_filters( 'opalestate_sortable_modes', $modes );

		$modes  = array_merge( array('' => __('Ordenar por','opalestate') ), $modes );
